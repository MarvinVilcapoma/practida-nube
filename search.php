...
<main class="container p-4">
  <div class="row">
    ...
    <h3> Busqueda </h3>
        ...
        <input type="search" name="descripcion" class="form-control" placeholder="Busqueda por id o descripcion" >
        <br>
    ...
    <div class="col-md-11">
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          $result_articulo = mysqli_query($conn,"SELECT * FROM articulo WHERE descripcion LIKE '%".$descripcion."%' OR id LIKE '%".$descripcion."%' ");    
          while($row = mysqli_fetch_array($result_articulo)) { ?>
          <tr>
